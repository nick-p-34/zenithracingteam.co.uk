                ...
                <div className="grid items-start gap-8 lg:grid-cols-[1.25fr_0.9fr]">
                    <div className="space-y-6">
                        ...
                        <p className="max-w-2xl text-lg leading-relaxed text-[#dfdfdf] md:text-xl">
                            We're thrilled to announce the launch of Zenith Racing, a new grassroots racing team aiming
                            for the ICCR. As we prepare for our inaugural season, we invite you to join us on
                            this exciting journey. Follow our progress as we build our car, develop our team, and take
                            on the competition. Stay tuned for updates, and contact us if you want to show your support!
                        </p>
                    </div>

                    <aside className="retro-panel interactive-panel p-5 md:p-6">
                        <h2 className="mb-4 text-base font-bold uppercase tracking-[0.2em] text-[#ffffff]">Pit Wall
                            Teaser</h2>
                        <div className="space-y-3">
                            {teaserCards.map((card, index) => (
                                ...
                                >
                                    <h3 className="text-sm font-bold uppercase tracking-[0.16em] text-[#f1f1f1]">{card.title}</h3>
                                    <p className="mt-2 text-sm leading-relaxed text-[#c4c4c4]">{card.text}</p>
                                </motion.article>
                            ))}
                        </div>
                    </aside>
